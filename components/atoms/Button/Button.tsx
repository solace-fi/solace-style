...
const ButtonAppearanceCss = css<ButtonType & GeneralElementType>`
    outline: none;
...
const ButtonBaseCss = css<ButtonType & GeneralElementType>`
    display: inline-flex;
    align-items: center;
...
export const Button = styled.button<ButtonType & GeneralElementType>``
